...
return (new CustomEvent(event_name,(function (){var obj27388 = {"detail":data};
return obj27388;
})()));
} else {
...
var f = (function (){var pred__27395 = cljs.core._EQ_;
var expr__27396 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27395.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27396))){
return ((function (pred__27395,expr__27396){
return (function (p1__27389_SHARP_){
return console.warn(p1__27389_SHARP_);
});
;})(pred__27395,expr__27396))
} else {
if(cljs.core.truth_(pred__27395.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27396))){
return ((function (pred__27395,expr__27396){
return (function (p1__27390_SHARP_){
return console.debug(p1__27390_SHARP_);
});
;})(pred__27395,expr__27396))
} else {
if(cljs.core.truth_(pred__27395.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27396))){
return ((function (pred__27395,expr__27396){
return (function (p1__27391_SHARP_){
return console.error(p1__27391_SHARP_);
});
;})(pred__27395,expr__27396))
} else {
return ((function (pred__27395,expr__27396){
return (function (p1__27392_SHARP_){
return console.log(p1__27392_SHARP_);
});
;})(pred__27395,expr__27396))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27399){
...
var opts = map__27400__$1;
var eval_fn = cljs.core.get.call(null,map__27400__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__27402_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__27404,(0),null);
...
}catch (e27409){if((e27409 instanceof Error)){
var e = e27409;
return not_found;
} else {
throw e27409;
...
//# sourceMappingURL=utils.js.map?rel=1538771240652
