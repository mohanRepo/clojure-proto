...
var G__25631 = o;
(G__25631[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__25635 = o;
(G__25635[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__25637__i < G__25637__a.length) {G__25637__a[G__25637__i] = arguments[G__25637__i + 0]; ++G__25637__i;}
  args = new cljs.core.IndexedSeq(G__25637__a,0,null);
} 
...
var G__25640 = props;
var G__25640__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__25640,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__25640);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__25640__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__25641){
var map__25642 = p__25641;
var map__25642__$1 = ((((!((map__25642 == null)))?(((((map__25642.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25642.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25642):map__25642);
var props = map__25642__$1;
var class$ = cljs.core.get.call(null,map__25642__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__25642,map__25642__$1,props,class$){
return (function (c){
...
});})(map__25642,map__25642__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__25644){
...
var on_write = cljs.core.get.call(null,map__25645__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__25645,map__25645__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__25645,map__25645__$1,on_write))
);
} else {
...
var G__25648 = jsprops;
(G__25648["defaultValue"] = value);

(G__25648["onChange"] = ((function (G__25648,v,value,on_change){
return (function (p1__25647_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__25647_SHARP_);
});})(G__25648,v,value,on_change))
);
...
var vec__25651 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__25651,(0),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___25655 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___25655 == null)){
} else {
var key_25656 = temp__5461__auto___25655;
(jsprops["key"] = key_25656);
}
...
var temp__5461__auto___25657 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___25657 == null)){
} else {
var key_25658 = temp__5461__auto___25657;
reagent.impl.template.oset.call(null,jsprops,"key",key_25658);
}
...
var G__25659 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__25659["name"] = c);
...
var len__4531__auto___25664 = arguments.length;
var i__4532__auto___25665 = (0);
while(true){
if((i__4532__auto___25665 < len__4531__auto___25664)){
args__4534__auto__.push((arguments[i__4532__auto___25665]));

var G__25666 = (i__4532__auto___25665 + (1));
i__4532__auto___25665 = G__25666;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq25662){
...
break;
default:
var G__25669 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__25669;
continue;
...
var n__4408__auto___25671 = a.length;
var i_25672 = (0);
while(true){
if((i_25672 < n__4408__auto___25671)){
(a[i_25672] = reagent.impl.template.as_element.call(null,(a[i_25672])));

var G__25673 = (i_25672 + (1));
i_25672 = G__25673;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4408__auto___25674 = a.length;
var i_25675 = (0);
while(true){
if((i_25675 < n__4408__auto___25674)){
var val_25676 = (a[i_25675]);
if(((cljs.core.vector_QMARK_.call(null,val_25676)) && ((reagent.impl.template.key_from_vec.call(null,val_25676) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_25675] = reagent.impl.template.as_element.call(null,val_25676));

var G__25677 = (i_25675 + (1));
i_25675 = G__25677;
continue;
} else {
}
...
var ctx = ({});
var vec__25678 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__25678,(0),null);
var derefed = cljs.core.nth.call(null,vec__25678,(1),null);
...
var G__25681 = (cljs.core.count.call(null,argv) - first_child);
switch (G__25681) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__25681){
