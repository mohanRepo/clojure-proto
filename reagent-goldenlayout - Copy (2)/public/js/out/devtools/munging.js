...
var o23488 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23488["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23489 = temp__5455__auto____$1;
return (o23489["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__23329__auto__ = f;
return (o__23329__auto__["toString"]).call(o__23329__auto__);
} else {
return "";
}
}catch (e23490){var _ = e23490;
return "";
}});
...
try{var o__23329__auto___23492 = t;
(o__23329__auto___23492["cljs$lang$ctorPrWriter"]).call(o__23329__auto___23492,t,writer);
}catch (e23491){var __23493 = e23491;
}
...
var char_code = (function (){var o__23329__auto__ = (new String(char$));
return (o__23329__auto__["charCodeAt"]).call(o__23329__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__23329__auto__ = String;
return (o__23329__auto__["fromCharCode"]).call(o__23329__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23494 = num_code;
switch (G__23494) {
case (1):
return (185);
...
var o__23329__auto__ = String;
return (o__23329__auto__["fromCharCode"]).call(o__23329__auto__,superscript_code);
});
/**
...
}catch (e23496){var _e__23336__auto__ = e23496;
return false;
}})())){
...
var vec__23497 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23497,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o23500 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23500["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23501 = temp__5455__auto____$1;
return (o23501["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___23508 = arguments.length;
var i__4532__auto___23509 = (0);
while(true){
if((i__4532__auto___23509 < len__4531__auto___23508)){
args__4534__auto__.push((arguments[i__4532__auto___23509]));

var G__23510 = (i__4532__auto___23509 + (1));
i__4532__auto___23509 = G__23510;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23504){
var vec__23505 = p__23504;
var ns_detector = cljs.core.nth.call(null,vec__23505,(0),null);
...
var G__23511 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23512 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23511;
remaining_tokens = G__23512;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23502){
var G__23503 = cljs.core.first.call(null,seq23502);
var seq23502__$1 = cljs.core.next.call(null,seq23502);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23503,seq23502__$1);
});
...
var vec__23516 = cljs.core.split_with.call(null,(function (p1__23515_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23515_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23516,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23516,(1),null);
...
var vec__23519 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23519,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23519,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23522 = cljs.core.rest.call(null,remaining_tokens);
var G__23523 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23522;
name_tokens = G__23523;
continue;
} else {
...
var vec__23526 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23526,(0),null);
var arity = cljs.core.nth.call(null,vec__23526,(1),null);
var vec__23529 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23529,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23529,(1),null);
var vec__23532 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23532,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23532,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23532,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23532,(3),null);
...
var vec__23538 = result;
var munged_ns = cljs.core.nth.call(null,vec__23538,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23538,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23538,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23538,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23538,(4),null);
var arity = cljs.core.nth.call(null,vec__23538,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23542 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23542,(0),null);
var args = cljs.core.nth.call(null,vec__23542,(1),null);
var vec__23545 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23545,(0),null);
var name = cljs.core.nth.call(null,vec__23545,(1),null);
...
var G__23548 = (arity + (1));
var G__23549 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23550){
var vec__23551 = p__23550;
var arity = cljs.core.nth.call(null,vec__23551,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23551,(1),null);
...
return cljs.core.get.call(null,arities,p1__23554_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23555_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___23562 = arguments.length;
var i__4532__auto___23563 = (0);
while(true){
if((i__4532__auto___23563 < len__4531__auto___23562)){
args__4534__auto__.push((arguments[i__4532__auto___23563]));

var G__23564 = (i__4532__auto___23563 + (1));
i__4532__auto___23563 = G__23564;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23558){
var vec__23559 = p__23558;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23559,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23556){
var G__23557 = cljs.core.first.call(null,seq23556);
var seq23556__$1 = cljs.core.next.call(null,seq23556);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23557,seq23556__$1);
});
...
var map__23567 = options;
var map__23567__$1 = ((((!((map__23567 == null)))?(((((map__23567.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23567.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23567):map__23567);
var include_ns_QMARK_ = cljs.core.get.call(null,map__23567__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23567__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23567__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23567__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23568 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23568,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23568,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23568,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23568,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23568,(4),null);
var arity = cljs.core.nth.call(null,vec__23568,(5),null);
...
var o__23329__auto__ = f;
return (o__23329__auto__["getBasis"]).call(o__23329__auto__);
});
/**
...
}catch (e23572){var _e__23336__auto__ = e23572;
...
var G__23573 = (obj[cljs.core.first.call(null,path)]);
var G__23574 = cljs.core.rest.call(null,path);
obj = G__23573;
path = G__23574;
continue;
} else {
...
return (function (accum,p__23575){
var vec__23576 = p__23575;
var bit = cljs.core.nth.call(null,vec__23576,(0),null);
var protocol = cljs.core.nth.call(null,vec__23576,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23579){
var vec__23580 = p__23579;
var ns = cljs.core.nth.call(null,vec__23580,(0),null);
var name = cljs.core.nth.call(null,vec__23580,(1),null);
var selector = cljs.core.nth.call(null,vec__23580,(2),null);
...
return (function (p__23584){
var vec__23585 = p__23584;
var munged_name = cljs.core.nth.call(null,vec__23585,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23585,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23585,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23583_SHARP_){
return (obj[cljs.core.first.call(null,p1__23583_SHARP_)]);
});})(name,sorted_matches,vec__23585,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
