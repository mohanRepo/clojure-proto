...
return cljs.core.reduce.call(null,(function (result,p__24829){
...
var vec__24833 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__24833,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__24833,(1),null);
var ab = cljs.core.nth.call(null,vec__24833,(2),null);
...
return (function (){var G__24842 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24842__$1)].join('')));
